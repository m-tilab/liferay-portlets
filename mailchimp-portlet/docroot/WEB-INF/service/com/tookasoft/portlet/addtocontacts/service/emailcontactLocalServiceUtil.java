...
/**
 * The utility for the emailcontact local service. This utility wraps {@link com.tookasoft.portlet.addtocontacts.service.impl.emailcontactLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class emailcontactLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.tookasoft.portlet.addtocontacts.service.impl.emailcontactLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact addemailcontact(
	...
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact createemailcontact(
		long emailId) {
		return getService().createemailcontact(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact deleteemailcontact(
		long emailId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteemailcontact(emailId);
	}
	...
	*/
	...
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact fetchemailcontact(
		long emailId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchemailcontact(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact getemailcontact(
		long emailId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getemailcontact(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.tookasoft.portlet.addtocontacts.model.emailcontact> getemailcontacts(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact updateemailcontact(
		com.tookasoft.portlet.addtocontacts.model.emailcontact emailcontact)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailcontact updateemailcontact(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateemailcontact(emailcontact, merge);
	}
	...
	*/
	...
	public static emailcontactLocalService getService() {
		if (_service == null) {
			InvokableLocalService invokableLocalService = (InvokableLocalService)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					emailcontactLocalService.class.getName());

			if (invokableLocalService instanceof emailcontactLocalService) {
				_service = (emailcontactLocalService)invokableLocalService;
			}
			else {
				_service = new emailcontactLocalServiceClp(invokableLocalService);
			}

			ReferenceRegistry.registerReference(emailcontactLocalServiceUtil.class,
				"_service");
		}
	 ...
	 * @deprecated
	 */
	public void setService(emailcontactLocalService service) {
	}

	private static emailcontactLocalService _service;
}
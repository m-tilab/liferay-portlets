...
/**
 * The utility for the emailaddress local service. This utility wraps {@link com.tookasoft.portlet.addtocontacts.service.impl.emailaddressLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
 ...
 * @see com.tookasoft.portlet.addtocontacts.service.base.emailaddressLocalServiceBaseImpl
...
public class emailaddressLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link com.tookasoft.portlet.addtocontacts.service.impl.emailaddressLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress addemailaddress(
	...
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress createemailaddress(
		long emailId) {
		return getService().createemailaddress(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress deleteemailaddress(
		long emailId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().deleteemailaddress(emailId);
	}
	...
	*/
	...
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress fetchemailaddress(
		long emailId)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().fetchemailaddress(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress getemailaddress(
		long emailId)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		return getService().getemailaddress(emailId);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<com.tookasoft.portlet.addtocontacts.model.emailaddress> getemailaddresses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static com.tookasoft.portlet.addtocontacts.model.emailaddress updateemailaddress(
		com.tookasoft.portlet.addtocontacts.model.emailaddress emailaddress)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static emailaddressLocalService getService() {
		if (_service == null) {
			...
			if (invokableLocalService instanceof emailaddressLocalService) {
				_service = (emailaddressLocalService)invokableLocalService;
			}
			else {
				_service = new emailaddressLocalServiceClp(invokableLocalService);
			}
